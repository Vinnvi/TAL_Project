...
behaviour = ["in group","pack","alone"]
dietary = ["herbivorous","omnivorous","carnivorous"]
...
#------------- READING -------------
yesWords = ["y", "ye", "yeah", "yea", "yes", "agree", "like", "correct", "case", "indeed", "be", "is", "course", "think", "suppose", "guess", "sure", "yup", "am", "can", "do", "does", "yos", "affirmative", "ok", "okay", "will"]
noWords = ["no", "nor", "not", "neither", "without", "n", "nah", "nope", "wrong", "nop", "doubt", "mistake", "negative", "why", "niet", "nie"]
...
# Ends the game with a little message to let the user know they angered the bot
def botQuit():
    print("(Your interlocutor and the audience left, leaving you all alone...)")
    sys.exit(0)
